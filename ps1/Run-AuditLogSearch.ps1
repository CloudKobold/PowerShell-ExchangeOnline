# taken  from https://docs.microsoft.com/en-us/office365/troubleshoot/audit-logs/mailbox-audit-logs
# and adjusted for easier use

function Perform-AuditLogSearch {
